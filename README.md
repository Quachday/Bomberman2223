...
## Nhiệm vụ của bạn
- Gói bắt buộc (+6đ)
1. Xây dựng bản đồ màn chơi từ tệp cấu hình (có mẫu tệp cấu hình, xem [tại đây](https://raw.githubusercontent.com/bqcuong/bomberman-starter/starter-2/res/levels/Level1.txt)) +1đ DONE
2. Di chuyển Bomber theo sự điều khiển từ người chơi +1đ DONE
3. Tự động di chuyển các Enemy +1đ DONE
4. Xử lý va chạm cho các đối tượng Bomber, Enemy, Wall, Brick, Bomb +1đ DONE
5. Xử lý bom nổ +1đ DONE
